                ...
                >
                  ...
                  <div className="mt-10 flex items-center justify-center md:justify-start gap-4 flex-wrap">
                    ...
                    <a
                      ...
                      onMouseEnter={() => play('hover')}
                      onClick={() => play('click')}
                      className="flex items-center gap-2 px-6 py-3 rounded-full font-mono text-xs tracking-widest uppercase border border-[var(--muted)] text-[var(--text)] hover:border-[var(--accent)] hover:text-[var(--accent)] transition-colors"
                    >
