  ...
  return (
    <header
      className={`fixed top-0 inset-x-0 z-50 transition-all duration-500 ${
        scrolled ? 'py-3 backdrop-blur-md' : 'py-5 sm:py-6'
      }`}
      style={{
    ...
    >
      <nav className="max-w-6xl mx-auto px-4 sm:px-6 flex items-center justify-between gap-3">
        <button
          onClick={() => scrollTo('hero')}
          className="font-display text-xs sm:text-sm tracking-[0.2em] sm:tracking-[0.3em] text-[var(--text)] shrink-0"
        >
