...
export default function About() {
  const ref = useSpeakOnView(
    'Section: Profile. Full-stack developer with two and a half years of experience building PHP, Laravel, and React applications.',
    'about',
  )
  return (
    <section id="about" ref={ref} className="relative py-24 md:py-28 px-5 sm:px-6">
